...
-- ============================================================
INSERT INTO menu_items (category_id, name, description, price, price_label, sort_order) VALUES
  ((SELECT id FROM categories WHERE slug='grillades'), 'Côtes Piano', NULL, 19, NULL, 1),
  ((SELECT id FROM categories WHERE slug='grillades'), 'Côtes Piano XXL', NULL, 28, NULL, 2),
  ((SELECT id FROM categories WHERE slug='grillades'), 'Filet de volaille épicée', NULL, 18, NULL, 3),
  ((SELECT id FROM categories WHERE slug='grillades'), 'Filet de volaille au maroilles', NULL, 20, NULL, 4),
