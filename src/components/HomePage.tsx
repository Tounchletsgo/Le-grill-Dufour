  ...
  return (
    <>
      ...
      <header className="site-header" id="site-header">
        <div className="container header-inner">
          ...
          <nav className="main-nav" aria-label="Navigation principale">
            <a href="#presentation">La Maison</a>
            ...
            <a href="#carte" className="nav-order-link">Commander</a>
          </nav>
          ...
          <div className="header-actions">
            ...
            <a href="#contact" className="btn btn-primary btn-sm">Réserver une table</a>
      ...
      <nav className="mobile-nav" aria-label="Navigation mobile">
        ...
        <a href="#horaires">Horaires</a>
        <a href="#contact">Contact</a>
        <a href="#carte" className="btn btn-primary">Commander en ligne</a>
      </nav>
        ...
        <section className="hero" id="hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-ctas">
              <a href="#contact" className="btn btn-primary">Réserver une table</a>
              <a href="#carte" className="btn btn-outline">Découvrir la carte</a>
            </div>
          </div>
        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-col">
              <h4>Navigation</h4>
              <ul>
                <li><a href="#presentation">La Maison</a></li>
